...
def get_geos_paths():
    ...
    if include_dir and library_dir:
        return {
            "include_dirs": ["pygeos/src", include_dir, np.get_include()],
